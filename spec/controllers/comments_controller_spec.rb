...
RSpec.describe Api::CommentsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new Comment" do
        expect {
          post :create, params: {comment: valid_attributes}, session: valid_session, format: :json
        }.to change(Comment, :count).by(1)
      end

      it "returns the corresponding comment JSON" do
        post :create, params: {comment: valid_attributes}, session: valid_session, format: :json
    ...
    context "with invalid params" do
      it "return 422" do
        post :create, params: {comment: invalid_attributes}, session: valid_session, format: :json
  ...
  describe "DELETE #destroy" do
    ...
    it "destroys the requested comment" do
      comment = Comment.create! valid_attributes
      expect {
        delete :destroy, params: {id: comment.to_param}, session: valid_session, format: :json
      }.to change(Comment, :count).by(-1)
    end

    it "returns the comment JSON that was just destroyed" do
      comment = Comment.create! valid_attributes
      delete :destroy, params: {id: comment.to_param}, session: valid_session, format: :json
